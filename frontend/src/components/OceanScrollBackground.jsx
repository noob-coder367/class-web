...
function wavePath(width, y, rise) {
  ...
  // Chỉ phủ ~90px dưới mặt sóng để blend mượt vào gradient nước
  const depth = 90;
  return [
    `M${-extra} ${y}`,
...
function computeTimeOfDay() {
  ...
  const palettes = {
    dawn: {
      ...
      waterTop: "#2a6b8a",
      baseGradient:
        "linear-gradient(to bottom, #1a2a4a 0%, #e07a5f 18%, #5a9bb8 35%, #38b7d3 50%, #1d85b8 65%, #0d4e8a 80%, #031638 100%)",
    },
    morning: {
      skyTop: "#5ba3d9",
      skyMid: "#a8d5f0",
      ...
      waterTop: "#38b7d3",
      baseGradient:
        "linear-gradient(to bottom, #5ba3d9 0%, #4ab0d4 15%, #38b7d3 30%, #2a9bc4 45%, #1d85b8 60%, #0d4e8a 80%, #031638 100%)",
    },
    noon: {
      skyTop: "#4a9fd8",
      skyMid: "#87ceeb",
      ...
      waterTop: "#38b7d3",
      baseGradient:
        "linear-gradient(to bottom, #4a9fd8 0%, #3eb0d6 12%, #38b7d3 25%, #2a9bc4 40%, #1d85b8 55%, #0d4e8a 75%, #031638 100%)",
    },
    afternoon: {
      skyTop: "#3a8fc0",
      skyMid: "#7ab8d9",
      ...
      waterTop: "#2d9bb8",
      baseGradient:
        "linear-gradient(to bottom, #3a8fc0 0%, #2d9bb8 18%, #2590b0 35%, #1d85b8 50%, #156a9e 65%, #0d4e8a 80%, #031638 100%)",
    },
    sunset: {
      skyTop: "#2c1e3e",
      skyMid: "#c44536",
      ...
      waterTop: "#1a5a7a",
      baseGradient:
        "linear-gradient(to bottom, #2c1e3e 0%, #c44536 15%, #e07a5f 28%, #8a6a7a 42%, #2a6a8a 55%, #0d4e8a 75%, #031638 100%)",
    },
    night: {
      skyTop: "#0a0e1a",
      skyMid: "#12182b",
      ...
      waterTop: "#0d2a40",
      baseGradient:
        "linear-gradient(to bottom, #0a0e1a 0%, #0c1528 20%, #0d1a2e 40%, #0a2038 60%, #061a30 75%, #031638 90%, #01080f 100%)",
    },
  };
      ...
      >
        <defs>
          ...
          <linearGradient id="oceanWaterGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor={colors.waterTop} stopOpacity="0.75" />
            <stop offset="8%" stopColor={colors.waterTop} stopOpacity="0.82" />
            <stop offset="18%" stopColor="#2aa3c4" stopOpacity="0.88" />
            <stop offset="32%" stopColor="#1d85b8" stopOpacity="0.92" />
            <stop offset="48%" stopColor="#156a9e" stopOpacity="0.95" />
            <stop offset="62%" stopColor="#0d4e8a" stopOpacity="0.97" />
            <stop offset="78%" stopColor="#08305a" stopOpacity="0.98" />
            <stop offset="90%" stopColor="#052352" stopOpacity="0.99" />
        ...
        >
          <polygon
            points="250,500 380,500 580,1300 420,1300"
            fill="url(#rayGrad)"
            opacity="0.5"
          />
          <polygon
            points="550,500 650,500 820,1300 700,1300"
            fill="url(#rayGrad)"
            opacity="0.35"
          />
        </g>
