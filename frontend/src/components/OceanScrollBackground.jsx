...
export default function OceanScrollBackground() {
  ...
  const isRaining = condition === "light-rain" || condition === "heavy-rain";
  const isHeavyRain = condition === "heavy-rain";
            ...
            <>
              <SceneObject x={280} y={100} sx={sx} ox={offsetX} className="ocean-cloud ocean-cloud-extra-1">
                <g opacity={skyOpacity * 0.8}>
                  <ellipse cx="0" cy="0" rx="70" ry="22" fill={isNight ? "#2a3548" : "#c8d4e0"} />
                  <ellipse cx="-40" cy="-4" rx="40" ry="18" fill={isNight ? "#2a3548" : "#c8d4e0"} />
                  <ellipse cx="35" cy="-6" rx="42" ry="20" fill={isNight ? "#2a3548" : "#c8d4e0"} />
                </g>
              </SceneObject>
              <SceneObject x={1050} y={150} sx={sx} ox={offsetX} className="ocean-cloud ocean-cloud-extra-2">
                <g opacity={skyOpacity * 0.75}>
                  <ellipse cx="0" cy="0" rx="85" ry="26" fill={isNight ? "#2a3548" : "#b8c8d8"} />
                  <ellipse cx="-45" cy="-5" rx="48" ry="20" fill={isNight ? "#2a3548" : "#b8c8d8"} />
                </g>
              </SceneObject>
            </>
          )}
