  ...
  return (
    <div className="osb-root" aria-hidden="true">
      ...
      >
        ...
        <polygon points="248,300 280,210 318,230 350,170 400,300" fill="#6a7d4a" />
        <polygon points="310,300 338,240 368,255 400,210 440,300" fill="#567043" />
      </svg>
      ...
      >
        <g transform="translate(352,128)">
          ...
          <polygon points="-18,92 8,92 4,50 -12,50" fill="#8f9a55" />
