  ...
  return (
    <div className="ocean-background" aria-hidden="true">
      ...
      >
        ...
        {/* Bầu trời + núi + mặt trời + mây + chim */}
        ...
        {/* Rùa, cá, cá heo, cá đuối, sứa, cá lồng đèn */}
        ...
        {/* Đáy biển + san hô + rong rêu + kho báu + cua + sao biển */}
        <path d="M0 2250 Q250 2180 500 2220 T1000 2190 Q1120 2210 1200 2230 L1200 2600 L0 2600 Z" fill="url(#seabedGrad)" />
        <path d="M0 2320 Q350 2270 700 2330 T1200 2300 L1200 2600 L0 2600 Z" fill="url(#sandGrad)" />
