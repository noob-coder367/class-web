  ...
  return (
    <div className="ocean-background" aria-hidden="true">
      ...
      <svg className="ocean-svg-canvas" viewBox={`0 ${cameraY} ${viewW} ${viewH}`} preserveAspectRatio="none">
        ...
        <g className="ocean-light-rays" transform={`scale(${spanX}, 1)`} opacity={clamp((isNight ? 0.25 : sunElevation) * (1 - scrollProgress * 1.5))}>
        ...
        <g className="wave-motion-back">
          <path d={wavePath(viewW, 510, 40)} fill="url(#waveFadeGrad)" opacity="0.7" />
        </g>
        ...
        <g className="wave-motion-front">
          <path d={wavePath(viewW, 525, 35)} fill="url(#waveFadeGrad)" opacity="0.85" />
        </g>
